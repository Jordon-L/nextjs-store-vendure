...
import { getProductQuery } from "@/lib/graphql/product";
...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  const productDetails = useSuspenseQuery<ProductQuery>(getProductQuery, {
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:space-x-8">
          ...
          <section className="flex flex-col shrink space-y-4">
            ...
            {selected.stockLevel === "OUT_OF_STOCK" ? (
              <button
                className="buttonHover border-solid border-2 border-black p-4 h-16 cursor-not-allowed"
                disabled
              >
